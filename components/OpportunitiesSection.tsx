...
export default function OpportunitiesSection({ dbOpportunities = [] }: { dbOpportunities?: Opportunity[] }) {
  ...
  return (
    <section className="py-16 sm:py-24 bg-[#f8f9fa] border-b border-gray-200 font-['Montserrat',sans-serif]" id="opportunities-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {opportunities.length === 0 ? (
          ...
          /* Cards Grid — 3 columns with rounded-3xl and curved badges */
            ...
            return (
              ...
              >
                <div className="space-y-4">
                  ...
                  {/* Description */}
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed font-medium line-clamp-4">
                    {opp.description}
                  </p>
                </div>
